...
export default function DashProfile() {
  ...
  const uploadImage = async () => {
    ...
    const fileName = new Date().getTime() + imageFile.name; // Added parentheses to getTime()
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <div className="text-red-500 flex justify-between mt-5">
        <span className="cursor-pointer text-xl">Delete account</span>
        <span className="cursor-pointer text-xl">Sign out</span>
      </div>
    </div>
  );
}
